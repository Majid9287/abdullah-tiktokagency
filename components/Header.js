      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <Link href="/" className="flex items-center space-x-2 relative z-10">
          <div className="relative h-12 w-12">
            <Image src="/logo.png?height=40&width=40" alt="Abdullah Agency Logo" fill className="object-contain" />
          </div>
          <span
            className={`font-bold text-xl transition-colors duration-300 ${scrolled ? "text-pink-600" : "text-white"}`}
          >
            Abdullah Agency
          </span>
        </Link>
